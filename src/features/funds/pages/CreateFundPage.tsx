    ...
    <div className="animate-fade-in">
      ...
      <div className="page-content space-y-5">
        ...
        <div>
          ...
          <Popover>
            <PopoverTrigger asChild>
              <button className={cn("w-full bg-card border border-border rounded-xl px-4 py-3 text-sm text-left flex items-center gap-2", !startDate && "text-muted-foreground")}>
        ...
        <div>
          ...
          <Popover>
            <PopoverTrigger asChild>
              <button className={cn("w-full bg-card border border-border rounded-xl px-4 py-3 text-sm text-left flex items-center gap-2", !endDate && "text-muted-foreground")}>
                <CalendarIcon className="w-4 h-4 text-muted-foreground" />
